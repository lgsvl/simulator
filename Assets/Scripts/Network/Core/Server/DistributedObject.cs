...
namespace Simulator.Network.Core.Server
{
    ...
    /// </summary>
    public class DistributedObject : MonoBehaviour, IMessageSender
    {
...
#pragma warning restore 0649
        ...
        {
            //Replace DistributedObject with MockedObject if there is no distributed root
            if (Root == null)
            {
                gameObject.AddComponent<MockedObject>();
        ...
        {
            if (!SelectiveDistribution || AddressedEndPoints.Contains(endPoint))
