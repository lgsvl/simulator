...
namespace Simulator.Network.Core.Tests.Editor.Shared.Messaging.Data
{
    ...
    public class ByteCompressionTests
    {
        ...
        public static void Vector3CompressionTest(float x, float y, float z, float minElementValue, float maxElementValue, int bytesPerElement)
        {
            ...
            Assert.True(Mathf.Abs(vector3.x - resultVector3.x) <= precision,
            ...
            Assert.True(Mathf.Abs(vector3.y - resultVector3.y) <= precision,
            ...
            Assert.True(Mathf.Abs(vector3.z - resultVector3.z) <= precision,
