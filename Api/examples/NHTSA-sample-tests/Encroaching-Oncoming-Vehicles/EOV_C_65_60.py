...
egoState.transform = sim.map_point_on_lane(lgsvl.Vector(-35.16, 0.15, -97.97))
...
laneY = 0.15
laneZ = -85.25668
POVWaypoints.append(lgsvl.DriveWaypoint(lgsvl.Vector(laneX - 10.854, laneY, laneZ + 53.2), MAX_POV_SPEED))
POVWaypoints.append(lgsvl.DriveWaypoint(lgsvl.Vector(laneX - 10.854, laneY, laneZ + 45.4), MAX_POV_SPEED))
POVWaypoints.append(lgsvl.DriveWaypoint(lgsvl.Vector(laneX - 10.854, laneY, laneZ + 37.3), MAX_POV_SPEED))
...
POVWaypoints.append(lgsvl.DriveWaypoint(lgsvl.Vector(laneX + 38.198, laneY, laneZ - 14.43), MAX_POV_SPEED))
POVWaypoints.append(lgsvl.DriveWaypoint(lgsvl.Vector(laneX + 45.7, laneY, laneZ - 14.64), MAX_POV_SPEED))
POVWaypoints.append(lgsvl.DriveWaypoint(lgsvl.Vector(laneX + 53.968, laneY, laneZ - 14.95), MAX_POV_SPEED))

POVState = lgsvl.AgentState()
POVState.transform.position = lgsvl.Vector(laneX - 10.854, laneY, laneZ + 53.2)
