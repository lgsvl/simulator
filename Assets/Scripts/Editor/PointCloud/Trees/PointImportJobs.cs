...
namespace Simulator.Editor.PointCloud.Trees
{
    ...
    public static class PointImportJobs
    {
        ...
        public static void ConvertLasData(MemoryMappedViewAccessor accessor, PointCloudPoint[] target, int stride,
            int count, ref LasPointProcessor.LasHeader header, TransformationData transformationData,
            string progressBarTitle = null)
        {
            unsafe
            {
