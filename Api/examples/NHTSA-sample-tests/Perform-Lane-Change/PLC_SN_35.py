...
POV1State.transform = sim.map_point_on_lane(lgsvl.Vector(egoX - 12.27, egoY, egoZ + 2.75))
...
POV3State.transform = sim.map_point_on_lane(lgsvl.Vector(egoX + 12.02, egoY, egoZ + 0.84))
