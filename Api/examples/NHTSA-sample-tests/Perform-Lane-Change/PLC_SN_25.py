...
POV1State.transform = sim.map_point_on_lane(lgsvl.Vector(egoX - 10.28, egoY, egoZ + 2.89))
...
POV3State.transform = sim.map_point_on_lane(lgsvl.Vector(egoX + 10.02, egoY, egoZ + 0.7))
