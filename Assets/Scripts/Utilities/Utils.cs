...
public static class Utils
{
    ...
    public static bool IsPointCloseToLine(Vector2 p1, Vector2 p2, Vector2 pt)
    {
        bool isClose = false;
        ...
        if (Mathf.Sqrt(dx * dx + dy * dy) < SimulatorManager.Instance.mapManager.connectionProximity)
        {
            isClose = true;
        }
        return isClose;
