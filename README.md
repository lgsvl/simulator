...
It currently has integration with [Autoware Foundation](https://www.autoware.org) autonomous driving for ROS / ROS 2 and Baidu's [Apollo 5.0](https://github.com/lgsvl/apollo-5.0)
